...
raw_df = spark.read.parquet("data/raw/events")  # Confirm path with Brian
...
event_summary.write.mode("overwrite").parquet("data/summary/event_summary")

metric_summary.write.mode("overwrite").parquet("data/summary/metric_summary")

room_summary.write.mode("overwrite").parquet("data/summary/room_summary")
